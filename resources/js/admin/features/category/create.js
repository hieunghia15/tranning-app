$(function () {
    const endpointApiCreateCategory = $('#endpointApiCreateCategory').val();
    const createCategoryForm = $('#createCategoryForm');
    const validator = createCategoryForm.validate({
        ignore: '',
        rules: {
            name: {
                required: true,
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status === 'success') {
                    ...
                    showSuccess(CATEGORY_MESSAGES.created_success)
                } else {
                    showError(CATEGORY_MESSAGES.created_fail)
                }
            },
